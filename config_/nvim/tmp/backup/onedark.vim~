...
let s:colors = {
      ...
      \ "black": get(s:overrides, "black", { "gui": "#181b22", "cterm": "235", "cterm16": "0" }),
      \ "visual_black": get(s:overrides, "visual_black", { "gui": "#000000", "cterm": "NONE", "ctermfg": "#000000", "cterm16": "0" }),
      \ "comment_grey": get(s:overrides, "comment_grey", { "gui": "#5C6370", "cterm": "59", "cterm16": "15" }),
      \ "gutter_fg_grey": get(s:overrides, "gutter_fg_grey", { "gui": "#4B5263", "cterm": "234", "cterm16": "15" }),
